...
public class TaskTest {
    ...
    @Test
    public void shouldGetAndSetCreatedAtDateOnTask() throws Exception {
        Task t = new Task();
        t.setCreatedAt(format.parse("2015-03-12"));
        assertEquals("Thu Mar 12 00:00:00 CDT 2015", t.getCreatedAt().toString());
    }

    @Test
    public void shouldGetAndSetUpdatedAtDateOnTask() throws Exception {
        Task t = new Task();
        t.setUpdatedAt(format.parse("2015-03-13"));
        assertEquals("Fri Mar 13 00:00:00 CDT 2015", t.getUpdatedAt().toString());
    }
